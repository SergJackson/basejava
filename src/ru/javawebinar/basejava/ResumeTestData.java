...
public class ResumeTestData {
    ...
    public static void main(String[] args) {
        storage.save(genResume(UUID.randomUUID().toString(), "Григорий Кислин"));
        printAll();
    }

    public static Resume genResume(String uuid, String fullName) {
        ...
        resume.setSection(
                ...
                new SingleLineSection("Ведущий стажировок и корпоративного обучения по Java Web и Enterprise технологиям")
    ...
    public static Resume genResumeTest(String uuid, String fullName) {
        Resume resume = new Resume(uuid, fullName);
        // Fill contacts
        resume.setContact(ContactType.PHONE, "+7(921) 855-0482");
        resume.setContact(ContactType.SKYPE, "grigory.kislin");
        ...
        resume.setSection(
                ...
                new ListSection(
                        Arrays.asList(
                                "Реализация двухфакторной аутентификации для онлайн платформы управления проектами Wrike. Интеграция с Twilio, DuoSecurity, Google Authenticator, Jira, Zendesk.",
                                "Налаживание процесса разработки и непрерывной интеграции ERP системы River BPM. Интеграция с 1С, Bonita BPM, CMIS, LDAP. Разработка приложения управления окружением на стеке: Scala. Разработка SSO аутентификации и авторизации различных ERP модулей, интеграция java сервера.",
                                "Реализация c нуля Rich Internet Application приложения на стеке технологий JPA, Spring, Spring-MVC, GWT, ExtGWT GXT, Commet, HTML5, Highstock для алгоритмического трейдинга.",
                                "Создание JavaEE фреймворка для отказоустойчивого взаимодействия слабо-связанных сервисов SOA-base архитектура, JAX-WS, JMS, AS Glassfish. Сбор статистики сервисов и информации о состоянии через систему мониторинга Nagios. Реализация онлайн клиента для администрирования и мониторинга системы по JMX.",
                                "Реализация протоколов по приему платежей всех основных платежных системы России - Cyberplat, Eport, Chronopay, Сбербанк, Белоруcсии Erip, Osmp и Никарагуа."
                        )
                )
        );
    ...
    private static void printAll() {
        ...
        for (Resume r : storage.getAllSorted()) {
            System.out.println("Резуме [" + r.getUuid() + "]\n" + r.getFullName());
            System.out.println("----------------------------");
